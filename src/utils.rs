...
pub fn run_simulation_thread(logger_ : Arc<Mutex<Logger>>, network_initializer_run_simulation: Arc<Mutex<Result<NetworkInitializer, ConfigError>>>)-> std::thread::JoinHandle<()> {
    thread::spawn(move || {
